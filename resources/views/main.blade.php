...
@section('content')
    ...
    <div class="container my-5">
        ...
        <p class="text-center">Мы - ресторан, который предлагает вам лучшие блюда, приготовленные с любовью. Наша команда профессионалов всегда готова сделать ваше пребывание у нас незабываемым. Адреса наших ресторанов:</p>
